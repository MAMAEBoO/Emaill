...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_data           wargrtne zanyare hawrekan
   get_info            darxstne zanyary hawrekant

   dump_id            dar henane id hawre kant 
   dump_phone         dar henane raqam talaphone hawre kant
   dump_mail          dar henane email hawrekant
   dump_<id>_id       dar henane id yake dyary kraw
		      ex: dump_username_id

   token              daxl krdne account facebook
   cat_token          neshan dane token facebook ka kaw
   rm_token           chwna darawa account

   bot                krdna way menu

   clear              pakrdnaway terminal
   help               darxstne yarmate
   about              darxstne yarmate darbaray tool
   exit               chwna darawa la program
'''%(G,W)
def menu_bot():
	print '''
   %sNumber                  INFO%s
 ---------   ------------------------------------
   ...
   [ 01 ]      automatic like
   [ 02 ]      automatic comment
   [ 03 ]      automatic poke
   [ 04 ]      wargrtne hamw add kan
   [ 05 ]      srena way post kane timeline
   [ 06 ]      srena way hamw hawre kant
   [ 07 ]      unfollow krdne hamw hawrekant
   [ 08 ]      srenaway hamw rasma kan
...
def menu_reaction():
 ...
 ----------   ------------------------------------
   ...
   [ 00 ]      garana wa bo bashe menu
'''%(G,W)
####################################################################
#                     GENERATE ACCESS TOKEN
def get(data):
	print '[*] LOGIN KRDNE ACCOUNT'
	...
	try:
		...
		b.close()
		print '[*] Account ka ba sarkawtwe login bw '
		exit()
	except KeyError:
		print '[!] Account Daxl nabw email yan password halaya'
		print '[!] Hokar :  email or password'
		os.remove('cookie/token.log')
		main()
	except requests.exceptions.ConnectionError:
		print '[!] Account Daxl nabw  Xatt bra '
		print '[!] Connection error !!!'
		os.remove('cookie/token.log')
		main()
def id():
	print '[*] Daxl krdne account         ';id = raw_input('[?] Username : ');pwd = getpass.getpass('[?] Password : ');API_SECRET = '62f8ce9f74b12f84c123cc23437a4a32';data = {"api_key":"882a8490361da98702bf97a021ddc14d","credentials_type":"password","email":id,"format":"JSON", "generate_machine_id":"1","generate_session_cookies":"1","locale":"en_US","method":"auth.login","password":pwd,"return_ssl_resources":"0","v":"1.0"};sig = 'api_key=882a8490361da98702bf97a021ddc14dcredentials_type=passwordemail='+id+'format=JSONgenerate_machine_id=1generate_session_cookies=1locale=en_USmethod=auth.loginpassword='+pwd+'return_ssl_resources=0v=1.0'+API_SECRET
	x = hashlib.new('md5')
        x.update(sig)
...
def post():
	...
	try:
	  if WT == 'wallpost':
		print '[*] wargtne hamw post id kan'
		...
		print '[*] wargrtne hamw post id kan'
		...
		print '[*] wargrtne hamw add hawrekan'
		...
		print '[*] wargrtne id hamw hawrekant '
		...
		print '[*] wargrtne id hamw rasmakant '
		...
		print '[*] wargrt id hamw rasmakant'
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'A V A T A R' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'A V A T A R' + W +'/' + R +'Bot ' + W + '>> ')
